...
export const FurnitureCard: React.FC<furnitureCardProps> = ({ orientation, variations, withButton, withLengthInput, title, roomTag, furniture_tag }) => {
    ...
    const variationsRef =          variations?.map((variation) => {
      ...
      return {label: <div className="select-icon-wrapper">{priceIndex()}{variation.variation_name}</div>, value: variation.id.toString()}
    })
    ...
    function addFurnitureFromLocalStorage() {
      ...
      try {
        furnitureContext.setNewFurniture({room_tag: roomTag, furniture_tag, variation_id: String(variationId), length})
        ...
        <main className="card-main">
            ...
            <section className="card-wrapper">
              ...
              <section className="card-footer">
                {withLengthInput && <label className="card-input-length">
                ...
                {
                withButton && <button className="card-button" onClick={() => {
                  if (!clicked) {
